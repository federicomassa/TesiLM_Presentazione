...
\begin{frame}
\frametitle{Layout di ITk: Step-1}
\includegraphics<1>[width=\textwidth]{ExtBrl4}
\includegraphics<2>[width=\textwidth]{IExtBrl4}
\includegraphics<3>[width=\textwidth]{InclBrl4}
\end{frame}
%-----------------------------------------
\begin{frame}[t]
...
\item<1-> distribuzione di $\eta$ piatta
\item<1-> distribuzione di $\phi$ piatta
\end{itemize}}
\bigskip
\bigskip
\onslide<2->{
